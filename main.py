...
def text():            
            ...
            textframe = Frame(root,height=500,width=450,highlightbackground="black", highlightthickness=0,bg="white").place(x=150, y=110)
...
headfr = Frame(root,height=110,width=600,highlightbackground="black", highlightthickness=0,background='white').place(x=0, y=0)

panel = Label(headfr,height=70,width=70,image = img,background='white').place(x=30, y=10)

labela = Label(headfr, text = "Vehicle Recognition And Detection System",height=2,font=font.Font(family="Microsoft JhengHei UI Light",size=15),anchor='w',background='white').place(x=120, y=20)

sidefr = Frame(root,height=500,width=150,background='white',highlightbackground="black", highlightthickness=0).place(x=0, y=110)

add_Button = Button(sidefr, text = "Text Details",command=text,height=1,width=11,font=myfont,anchor='w',bg='white',fg="black",relief=FLAT).place(x=20, y=120)

add_Button = Button(sidefr, text = "Image Details", command = imagei,height=1,width=11,font=myfont,anchor='w',bg='white',fg="black",relief=FLAT).place(x=20, y=170)

add_Button = Button(sidefr, text = "Video Details", command = videoi, height=1,width=11,font=myfont,anchor='w',bg='white',fg="black",relief=FLAT).place(x=20, y=230)

add_Button = Button(sidefr, text = "BlackList", command = blist, height=1,width=11,font=myfont,anchor='w',bg='white',fg="black",relief=FLAT).place(x=20, y=280)
